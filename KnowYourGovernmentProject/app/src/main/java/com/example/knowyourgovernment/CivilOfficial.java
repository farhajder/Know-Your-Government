...
public class CivilOfficial implements Serializable {
    ...
    public CivilOfficial(String officialName, OfficialAddress officialAddress,
                         String officialParty, List<String> officialPhNumList,
                         List<String> officialEmailList, List<String> officialWebsiteList,
                         String officialPhotoLink, SocialMediaChannel socialMediaChannel) {
